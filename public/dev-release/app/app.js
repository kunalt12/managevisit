...
if (document.location.hostname == "localhost") {
    ...
    site = 'localhost';
} else if (document.location.hostname == "rbv.managevisit.com") {
    route_url = document.location.origin;
    apiRoutUrl = 'https://rbv.managevisit.com/';
    var logoURL = apiRoutUrl + 'public/assets/img/newlogo.png'
    site = 'rbv.managevisit.com';
} else {
...
var config = {};
if (document.location.hostname == "rbv.managevisit.com") {
