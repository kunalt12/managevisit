...
Despite TourManagement can be run without any development experience, it would be much easier if you already know something about it. In general following instruction do allow to run local copy by complete newbie, but it doesn't answer questions that can arise in the process of installation.
...
You will need to clone source code of TourManagement GitHub repository. To do this open console and execute following lines:
```bash
...
npm install
```
This will setup a working copy of TourManagement on your local machine
