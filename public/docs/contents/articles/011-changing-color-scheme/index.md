...
We tried to make the process of changing color scheme in TourManagement as easy as possible. 

By default TourManagement has two color profiles: mint and blur.
This article will help you to create your own color profile.
Let's say you want to make TourManagement dark.
