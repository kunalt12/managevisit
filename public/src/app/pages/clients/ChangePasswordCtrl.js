...
(function () {
    ...
    /** @ngInject */
    function ChangePasswordCtrl($scope, fileReader, $filter, $timeout, $uibModal, $rootScope, $compile, $injector, $uibModalInstance, Notification, ClientsFactory, client_id) {
        ...
        $scope.change_password = function (t) {
            ...
            m.validate(t).success(function () {
                ClientsFactory.changePassword(client_id, $scope.changepassformscope).success(function (t) {
