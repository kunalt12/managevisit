...
(function () {
    ...
    function ListOrganizationsCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, OrganizationsFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            OrganizationsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('organizations','update');\" ui-sref='categories.organizations.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('organizations','delete');\" ng-confirm-click='Are you sure to delete this organization type?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                OrganizationsFactory.showDataTable(t).success(function (t) {
