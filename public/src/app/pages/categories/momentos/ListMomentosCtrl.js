...
(function () {
    ...
    function ListMomentosCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, MomentosFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            MomentosFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('momentos','update');\" ui-sref='categories.momentos.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('momentos','delete');\" ng-confirm-click='Are you sure to delete this momentos?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                MomentosFactory.showDataTable(t).success(function (t) {
