...
(function () {
    ...
    function ListMealsCtrl($scope, $route, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, MealsFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            MealsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('meals','update');\" ui-sref='mealsvalue.meals.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('meals','delete');\" ng-confirm-click='Are you sure to delete this meal?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                MealsFactory.showDataTable(t).success(function (t) {
