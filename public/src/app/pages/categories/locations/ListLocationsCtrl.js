...
(function () {
    ...
    function ListLocationsCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, LocationsFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            LocationsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('locations','update');\" ui-sref='categories.locations.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('locations','delete');\" ng-confirm-click='Are you sure to delete this location?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                LocationsFactory.showDataTable(t).success(function (t) {
