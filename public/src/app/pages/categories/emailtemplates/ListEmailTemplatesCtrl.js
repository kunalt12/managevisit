...
(function () {
    ...
    angular.module('BlurAdmin.pages.categories.affiliations')
        .controller('ListEmailTemplatesCtrl', ListEmailTemplatesCtrl);

    /** @ngInject */
    function ListEmailTemplatesCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, EmailtemplatesFactory, $timeout, Notification) {
        $scope.dtInstance = {};
        ...
        $scope.deleteRecord = function (e) {
            EmailtemplatesFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('emailtemplates','update');\" ui-sref='categories.emailtemplates.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('emailtemplates','delete');\" ng-confirm-click='Are you sure to delete this email?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                EmailtemplatesFactory.showDataTable(t).success(function (t) {
            ...
            $scope.dtColumns = [
                ...
                DTColumnBuilder.newColumn("title").withTitle("Title").withOption("searchable", !0),
