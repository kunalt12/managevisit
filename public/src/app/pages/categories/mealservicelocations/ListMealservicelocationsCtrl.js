...
(function () {
    ...
    function ListMealservicelocationsCtrl($scope, $state, $route, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, MealservicelocationsFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            MealservicelocationsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a  ng-if=\"havePermission('mealservicelocations','update');\" ui-sref='mealsvalue.mealservicelocations.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('mealservicelocations','delete');\" ng-confirm-click='Are you sure to delete this service location?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                MealservicelocationsFactory.showDataTable(t).success(function (t) {
