...
(function () {
    ...
    angular.module('BlurAdmin.pages.categories.affiliations')
        .controller('ListAffiliationsCtrl', ListAffiliationsCtrl);

    /** @ngInject */
    function ListAffiliationsCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, AffiliationsFactory, $timeout, Notification) {
        $scope.dtInstance = {};
        ...
        $scope.deleteRecord = function (e) {
            AffiliationsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('affiliations','update');\" ui-sref='categories.affiliations.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('affiliations','delete');\" ng-confirm-click='Are you sure to delete this affiliate?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                AffiliationsFactory.showDataTable(t).success(function (t) {
