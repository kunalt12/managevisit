...
(function () {
    ...
    function ListTransportsCtrl($scope, $state, fileReader, $filter, $uibModal, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, TransportsFactory, $timeout, Notification) {
        ...
        $scope.deleteRecord = function (e) {
            TransportsFactory.deleteRecord(e).success(function (e) {
        ...
        $scope.actionRoles = function (e, t, a) {
            return "<a ng-if=\"havePermission('transports','update');\" ui-sref='categories.transports.edit({ id: " + a.id + " })'><i class='fa fa-edit'></i></a> <a ng-if=\"havePermission('transports','delete');\" ng-confirm-click='Are you sure to delete this transports type?' confirmed-click='deleteRecord( " + a.id + " )'><i class='fa fa-trash'></i></a>"
        };
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withDataProp("data").withOption("ajax", function (t, a, o) {
                TransportsFactory.showDataTable(t).success(function (t) {
