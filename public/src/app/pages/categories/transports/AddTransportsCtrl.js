...
(function () {
    ...
    function AddTransportsCtrl($scope, fileReader, $filter, $uibModal, $rootScope, $compile, TransportsFactory, $timeout, $stateParams, $state, $injector, Notification) {
        ...
        $scope.errorMessage = TransportsFactory.validation, $scope.add_data = function (t) {
            m.validate(t).success(function () {
                $scope.isSubmitted = !0, TransportsFactory.addRecord($scope.formscope).success(function (t) {
