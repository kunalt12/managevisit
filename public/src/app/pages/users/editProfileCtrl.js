    ...
    function editProfileCtrl($scope, fileReader, $filter, $uibModal, $cookies, $rootScope, $compile, UsersFactory, $timeout, $stateParams, $state, $injector, Notification, RolesFactory) {
        ...
        $scope.add_data = function (t) {
            $scope.isSubmitted = !0, g.validate(t).success(function () {
                ...
                UsersFactory.editProfile($scope.urlID, $scope.formscope).success(function (t) {
                    ...
                    var a = {};
                    a = t.data, $cookies.put("authUser", JSON.stringify(a));
                    $scope.isSubmitted = !1;
                }).error(function (t) {
        ...
        $scope.change_password = function (t) {
            ...
            g.validate(t).success(function () {
                UsersFactory.updatePassword($scope.urlID, $scope.changepassformscope).success(function (t) {
                    Notification.success(t.success);
                    $scope.isSubmitted = !1;
                    $scope.changepassformscope = {};
                }).error(function (t) {
        ...
        $scope.change_availability = function (t) {
            ...
            g.validate(t).success(function () {
                if ($scope.formscope.availability === $scope.formscopestatus.status) {
                    ...
                    UsersFactory.updateAvailability($scope.urlID, $scope.formscopestatus).success(function (t) {
                        Notification.success(t.success);
