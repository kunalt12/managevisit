...
(function () {
    ...
    angular.module("BlurAdmin").factory("UsersFactory", ["$http", "$q", "$config", function ($http, $q, $config) {
        ...
        UsersFactory.addRecord = function (t) {
            var o = objectToFormData(t);
            return $http.post($config.api_url + "users", o, {
                headers: {
                    "Content-Type": void 0
                }
            });
        };
        UsersFactory.getRecord = function (t) {
            return $http.get($config.api_url + "users/" + t + "/edit");
        };
        ...
        UsersFactory.updateRecord = function (t, o) {
            var s = objectToFormData(o);
            return $http.post($config.api_url + "users/" + t, s, {
                headers: {
                    "Content-Type": void 0
                }
            });
        };
        UsersFactory.editProfile = function (t, o) {
            var s = objectToFormData(o);
            return $http.post($config.api_url + "users/" + t, s, {
                headers: {
                    "Content-Type": void 0
        ...
        UsersFactory.getVolunteers = function (t) {
            return $http.get($config.api_url + "users/get-volunteers-user/" + t);
        };
        UsersFactory.getCountry = function () {
            return $http.get($config.api_url + "get-countries");
        };
        UsersFactory.updatePassword = function (t, o) {
            return o._method = "PUT", $http.post($config.api_url + "users/change-password/" + t, o);
        };
        UsersFactory.updateAvailability = function (t, o) {
            return o._method = "PUT", $http.post($config.api_url + "users/change-availability/" + t, o);
        };
        UsersFactory.changePassword = function (t, o) {
            return o._method = "PUT", $http.post($config.api_url + "users/admin-change-password/" + t, o);
        };
        UsersFactory.resendEmail = function (t) {
            return $http.post($config.api_url + "users/resend-welcome-email", t);
        };
        UsersFactory.showDataTable = function (t) {
            return $http({
                method: "POST",
        ...
        UsersFactory.showAvailabilitiesDataTable = function (t) {
            return $http({
                method: "POST",
        ...
        UsersFactory.deleteRecord = function (t) {
            return $http.delete($config.api_url + "users/" + t);
        };
        return UsersFactory;
    }]);
})();